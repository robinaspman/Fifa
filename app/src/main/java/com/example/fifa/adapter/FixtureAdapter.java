package com.example.fifa.adapter;
...
import com.example.fifa.databinding.ListFixtureBinding;
import com.example.fifa.models.FixtureData;
...
public class FixtureAdapter extends RecyclerView.Adapter<FixtureViewHolder>{
    ...
    public void onBindViewHolder(@NonNull FixtureViewHolder holder, int position) {
        ...
        holder.textView_match.setText(String.format("%s vs %s", data.homeName, data.awayName));
        ...
        try {
            ...
            holder.textView_time.setText(String.format("%s\n%s", dateFormat.format(Objects.requireNonNull(date)), timeFormat.format(date)));
...
class FixtureViewHolder extends RecyclerView.ViewHolder {
    private ListFixtureBinding binding;

    public ImageView imageView_home;
    public ImageView imageView_away;
    public TextView textView_home, textView_away, textView_time, textView_match;
